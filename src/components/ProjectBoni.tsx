...
const gallery = [
  {
    ...
    desc: 'Изработка и монтажа на рекламен пано на објектот.'
  },
  {
    src: 'https://via.placeholder.com/400x300?text=Слика+2',
    alt: 'Брендирање на ентериер',
    desc: 'Брендирање на ентериерот со корпоративни елементи.'
  },
  {
...
export default function ProjectBoni() {
  return (
    <section className="py-16 px-4 max-w-4xl mx-auto">
      {/* Logo */}
      <div className="flex justify-center mb-8">
        <img src={logo} alt="Бони интегргадба Logo" className="h-36 w-auto rounded-lg shadow-lg bg-white p-4" />
      </div>
      {/* Title */}
      <h1 className="text-4xl font-bold mb-4 text-center" style={{ color: '#2B5C2B', fontFamily: 'serif' }}>
        Бони интегргадба
      </h1>
      {/* Gallery Section */}
      <div>
        <h2 className="text-2xl font-semibold mb-6 text-center" style={{ color: '#2B5C2B' }}>Погледни ги изработките:</h2>
